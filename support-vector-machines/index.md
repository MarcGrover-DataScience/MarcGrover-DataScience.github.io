...
The Wisconsin Breast Cancer Diagnostic dataset is loaded directly from scikit-learn using load_breast_cancer(). The feature matrix and binary target variable — malignant (0) or benign (1) — are extracted. As noted in the Goals and Objectives section, full data validation and exploratory analysis for this dataset were conducted in the [Decision Trees](https://marcgrover-datascience.github.io/decision-trees/) project and are not repeated here. A brief confirmation of dataset dimensions and class distribution is printed for reference.
...
An ROC-AUC of 0.9977 indicates that the model correctly ranks a randomly selected malignant observation above a randomly selected benign observation 99.77% of the time. This compares to the ROC-AUC of 0.9947 reported for the Gradient Boosted Trees model, placing SVM slightly above the previous benchmark on this dataset.
