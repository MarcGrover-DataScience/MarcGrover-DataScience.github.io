# # Import XGBoost's sklearn-compatible interface
# from xgboost import XGBClassifier
#
# # Works exactly like sklearn models
...
#
# xgb_model = XGBClassifier(
#     n_estimators=100,        # Like sklearn
#     max_depth=5,             # Like sklearn
#     learning_rate=0.1,       # XGBoost specific - controls boosting
#     subsample=0.8,           # XGBoost specific - row sampling
#     colsample_bytree=0.8,    # XGBoost specific - column sampling
#     gamma=0,                 # XGBoost specific - regularization
#     reg_alpha=0,             # L1 regularization
#     reg_lambda=1,            # L2 regularization
#     eval_metric='logloss'    # XGBoost specific metrics
# )

####  The above is all generic code which may be used in script or deleted once script completed
...
print("  • gamma: Minimum loss reduction for split (regularization)")
print("  • reg_alpha: L1 regularization")
print("  • reg_lambda: L2 regularization")

# Phase 1: Optimize n_estimators and learning_rate
print("\n[6a] Optimizing Number of Trees and Learning Rate...")
...
#
# # Phase 3: Optimize subsample and colsample_bytree
# print("\n[6c] Optimizing Sampling Parameters...")
...
# plt.show()
# print("✓ Sampling parameters heatmap saved")
#
# # Phase 4: Optimize regularization
# print("\n[6d] Optimizing Regularization Parameters...")
...
#
# # ============================================================================
# # 8. VISUALIZE OPTIMAL TREE
# # ============================================================================
# print("\n[8] Visualizing Optimal Tree from XGBoost Model...")
#
...
# plt.show()
# print("✓ Mid-ensemble tree visualization saved")
#
...
# print("")
# print("We'll focus on 'gain' as it measures actual contribution to accuracy")
# print("-" * 70)
#
