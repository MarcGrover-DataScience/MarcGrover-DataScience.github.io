...
**Model architecture**: a two-hidden-layer MLP (64 → 32 units, ReLU activation, Adam optimiser, L2 regularisation α = 0.0001, batch size 256), sized deliberately conservatively given the CPU-only training environment and the modest 92-column feature space.
